...
const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn("text-ui-md font-semibold leading-none tracking-tight", className)}
      {...props}
    />
  ),
);
...
/**
 * Subtítulo do cabeçalho. Antes cada tela improvisava com
 * `<p className="text-muted-foreground">` solto.
 */
