...
const directionLabels: Record<WebhookDirection, string> = {
  outbound: "Outbound (Koryn Task envia para uma URL externa)",
  inbound: "Inbound (sistema externo envia para o Koryn Task)",
};
 ...
 * `direction = 'inbound'`, a URL de destino não se aplica (o Koryn Task é
