      ...
      {tabs.map((tab) => {
        ...
        return (
          <Link
            ...
            href={tab.href}
            className={cn(
              "flex min-h-11 shrink-0 items-center border-b-2 border-transparent px-3 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground",
